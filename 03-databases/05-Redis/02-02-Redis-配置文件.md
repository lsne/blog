...
K 键空间通知，以 keyspace@<db> 为前缀
E 键事件通知， 以keyevent@<db> 为前缀
...
```ini
# 4.0 configuration file example

daemonize yes
pidfile /data1/redis5829/redis.pid
port 5829
unixsocket /tmp/redis5829.sock
unixsocketperm 755
timeout 30
loglevel notice
logfile /data1/redis5829/redis.log
databases 16
...
client-output-buffer-limit normal 32000000 16000000 5
client-output-buffer-limit slave 0 0 0
client-output-buffer-limit pubsub 32mb 8mb 60
rename-command flushdb 360redisflushdb
rename-command flushall 360redisflushall
rename-command shutdown 360redisshutdown
rename-command keys 360rediskeys
client-output-buffer-limit normal 32000000 16000000 5
